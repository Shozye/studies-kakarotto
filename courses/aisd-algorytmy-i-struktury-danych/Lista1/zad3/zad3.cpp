...
int main(){
    srand (time(NULL));
    DoubleCyclicLinkedList* list = new DoubleCyclicLinkedList();
    ...
    std::cout<<std::endl;
    DoubleCyclicLinkedList* first_list = new DoubleCyclicLinkedList();
    DoubleCyclicLinkedList* second_list = new DoubleCyclicLinkedList();
    for(int i = 0; i < 10; i++){
        first_list->append(i);

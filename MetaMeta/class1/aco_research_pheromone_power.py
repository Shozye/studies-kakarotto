...
AMOUNT_OF_TRIES_PER_N = 10
TIME = 3
DATASET_SIZES = list(range(15, 51, 5))
FILENAME = f"aco_ant_{research_type}_research_{AMOUNT_OF_TRIES_PER_N}_{TIME}.json"


def ant_amount_research():
    PARAMETER_DO_STROJENIA = [1, 1.25, 2, 3, 5]
        ...
        for dataset_size in DATASET_SIZES:
            ...
            for do_strojenia in PARAMETER_DO_STROJENIA:
                ...
                algos.ant_colony(min_round_trips=0,
                                 ...
                                 ant_count=CHANGE_IT,
                                 ant_speed=CHANGE_IT,
                                 decay_power=CHANGE_IT,
                                 best_path_smell=CHANGE_IT,
                                 pheromone_power=do_strojenia,
                                 distance_power=1)
